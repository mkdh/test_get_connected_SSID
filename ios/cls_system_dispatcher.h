...
/// clsSystemMessenger provides an simple async messaging interface between C/C++/QML and Objective-C source code.
/**
 */

class clsSystemDispatcher : public QObject {
    Q_OBJECT

public:
    static clsSystemDispatcher* instance();
...
private:
    explicit clsSystemDispatcher(QObject* parent = 0);
